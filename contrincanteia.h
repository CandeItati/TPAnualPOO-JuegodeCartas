...
// La clase ContrincanteIA representa cualquier jugador controlado por inteligencia artificial.
...
public:
    ...
    // Cada IA decidirá cuál es el mejor elemento para enfrentar al enemigo.
